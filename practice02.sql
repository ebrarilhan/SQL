...
insert into child values(105,3000,'Motor','Hasim'); --error aliriz
--cunku parent tabloda olmayan primary key ile childa ekleme yapamayiz.

--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
INSERT INTO child VALUES(null, 1007,'Phone', 'Aslan Yılmaz');
--ekleme olur cunku null istisnai durumdur.

--SORU 4: parent tablosundaki vergi_no 101 olan veriyi siliniz.
--child tablosundaki veri silinmeden parent tablodaki veri silinemez
delete from parent where vergi_no=101; --hata aldik
...
--burada da hata aliiz ayni sebepten oturu. once child silinmelidir.

--SORU 8: child tablosunu siliniz
drop table child;

--SORU 9: parent tablosunu siliniz.
drop table parent; -- su an silinebilir cunku child artik yok


--on delete cascade hakkinda sorular:
--bu komut ile artik child silinmeden parent silinebilecek.
...
delete from parent2; --silebiliri cunku tablonun icinde on delete var. parent icindeki veriler
--silindiginde child icindeki veriler de silinir.

--SORU2: parent2 tablosunu siliniz
drop table parent2 cascade; -- cascade komutunu buraya eklersek silebiliriz. aksi halde hata verir.
-- ancak burada child tablo silinmez. veri silmeden farkli olarak tablo silmede child 
--otomatik silinmez.

--SORU3: child2 tablosunu siliniz;
drop table child2; -- child tablosunu cascade eklemeden bu sekilde silebiliriz.
