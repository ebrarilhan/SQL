...
select round(avg(fiyat),2) from arac; -- round ile iki basamakli kusurat yazdik
...
-- SORU4: meslekler tablosunda soyisimi 'Bulut' olanları,
...
select * from meslekler offset 2 limit 5; --offseti atlama yapmak istedigimizde kullaniriz.
...
-- SORU1: Tüm film_name'leri, category'lerini ve filimlerde oynayan actor_name'leri 
--listeleyiniz.
--1. yol; left join ile
