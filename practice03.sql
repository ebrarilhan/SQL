...
update toptancilar 
set sirket_ismi='nokia', irtibat_ismi='Canan Can' where vergi_no=201;
...
update malzemeler
set malzeme_isim='Phone' where malzeme_isim='Telefon';
...
-- SORU7: malzemeler tablosundaki tüm malzemelerin malzeme_id değerini ted_vergino
